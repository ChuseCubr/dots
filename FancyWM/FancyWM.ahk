...
#^+u::Run "fancywm.exe --action PullWindowUp"
...
#^+i::Run "fancywm.exe --action CreateHorizontalPanel"
#^+e::Run "fancywm.exe --action CreateVerticalPanel"
#^+n::Run "fancywm.exe --action CreateStackPanel"
...
#n::Run "fancywm.exe --action MoveFocusLeft"
#u::Run "fancywm.exe --action MoveFocusUp"
#i::Run "fancywm.exe --action MoveFocusRight"
#e::Run "fancywm.exe --action MoveFocusDown"
...
#+n::Run "fancywm.exe --action SwapLeft"
#+u::Run "fancywm.exe --action SwapUp"
#+i::Run "fancywm.exe --action SwapRight"
#+e::Run "fancywm.exe --action SwapDown"
